...
# FIXME The following variables should be replaced/amended
export DISK1=/dev/disk/by-id/nvme-VENDOR_SOMETHING_00003_ID1
export DISK2=/dev/disk/by-id/nvme-VENDOR_SOMETHING_00003_ID1
# FIXME Replace this by your SSH pubkey!
export SSH_PUB_KEY="ssh-ed25519 AAAA..."
# choose whatever you want, it doesn't matter
export MY_HOSTNAME=hetzner01
# this has to be a number in this format exactly. You can replace the numbers though
export MY_HOSTID=00000001
export NIXOS_VERSION=26.05
...
wipefs -a $DISK1-part1 || true
wipefs -a $DISK1-part2 || true
wipefs -a $DISK2-part1 || true
wipefs -a $DISK2-part2 || true
...
zpool create -O mountpoint=none \
    ...
    -f \
    root_pool mirror $DISK1-part2 $DISK2-part2
